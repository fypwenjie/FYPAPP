...
public class PromotionScreen extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    private static final String GET_FOOD_URL = "https://fyp-wenjie.000webhostapp.com/food/promotion_food_list";
    private static final String KEY_FOOD_PID = "promotion_id";
    ObjectAnimator fade;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Promotion id", promotion_id.toString());
        ...
        new Food_list(promotion_id).execute();
    }
    ...
    public class Food_list extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(PromotionScreen.this);
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                if (jsonArray != null) {
                    ...
                    FoodAdapter foodAdapter = new FoodAdapter(foods, PromotionScreen.this);
        ...
        protected String doInBackground(String... strings) {
            ...
            information.put(KEY_FOOD_PID, p_id);
            Log.d("store id 2",p_id);
